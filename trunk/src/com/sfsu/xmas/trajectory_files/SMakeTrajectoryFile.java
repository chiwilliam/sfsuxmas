...
public class SMakeTrajectoryFile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fileName.length() > 0) {
            ...
            int k = Integer.parseInt(request.getParameter("kmeansk"));

            TrajectoryFileGenerator gX = new TrajectoryFileGenerator(SessionAttributeManager.getActivePrimaryExpressionDatabase(request), binUnit, k);
