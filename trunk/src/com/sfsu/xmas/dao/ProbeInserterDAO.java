...
//            "VALUES %_VALUES_%;";
    ...
    public void insertProbeExpression() {
    ...
    public void insertTrajectories(FileProbe probe) {
        try {
...
//            trajectoryInsertionSQL.append(")");
    ...
    public ResultSet getProbeTrajectory(String probeID) {
