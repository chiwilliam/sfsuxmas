...
public class TrajectoryFileGenerator {
    ...
    public TrajectoryFileGenerator(ExpressionDataSet expressionDatabase, double binUnit) {
    ...
    public synchronized void generateFiles(String fileName) {
        ...
        generateFile(fileName, false);

        dataAccess.removeTrajectoryBinViews(expressionDataSet.getNumberOfTimePeriods());
    }
    
    private synchronized boolean generateFile(String fileName, boolean collapsed) {
    ...
    private void outputXML(String fileName, Document doc, boolean collapsed) {
