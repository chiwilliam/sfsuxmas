...
<%
            ...
            String pageName = "Local_Install_Linux";
%>
                    ...
                    <div id="page_body_main_full">
                        ...
                        <div id="page_body_content">
                            ...
                            <div style="clear: both;">
                                ...
                                <p>
                                    Download Link: <a href="http://tintin.sfsu.edu:8080/xmas_downloads/linux.zip">Linux installation package</a>
                                </p>
                            </div>
                            ...
                            <div style="clear: both;">
                                ...
                                <p class="block_summary">
                                    <object width="425" height="344"><param name="movie" value="http://www.youtube.com/v/CCa896uH-rs&hl=en&fs=1"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/CCa896uH-rs&hl=en&fs=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="425" height="344"></embed></object>
                                </p>
                            </div>
